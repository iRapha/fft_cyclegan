...
from tv_loss import TV

class TVCycleGANModel(BaseModel):
    def name(self):
        return 'TVGAN'
    ...
    def backward_G(self):
        ...
        # combined loss
        loss_G = loss_G_A + loss_G_B + loss_cycle_A + loss_cycle_B + loss_idt_A + loss_idt_B + tv_loss
        loss_G.backward()
        ...
        self.tv_loss_A = tv_loss_A.data[0]
        self.tv_loss_B = tv_loss_B.data[0]
