...
if __name__ == '__main__':
    #  B_PRIME = 'diff_vis/140_A_fake_B.png'
    #  B = 'diff_vis/140_treeless_A_fake_B.png'
    #  save_img = '140_diff'

    B_PRIME = 'diff_vis/1021_withtree_fake_B.png'
    B = 'diff_vis/1021_withouttree_fake_B.png'
    save_img = '1021_diff'

    fakeB_smoothest = np.array(Image.open(B).convert('RGB'))
    fakeB = np.array(Image.open(B_PRIME).convert('RGB'))
    ...
    cv2.imwrite('diff_vis/{}.png'.format(save_img), get_diff(fakeB, fakeB_smoothest, strategy='to255'))
    #  cv2.waitKey(0)
